...
set(VCPKG_CRT_LINKAGE dynamic) # TODO evaluate whether we can use static CRT for wasm32-emscripten-threads
set(VCPKG_LIBRARY_LINKAGE static)
set(VCPKG_CMAKE_SYSTEM_NAME Emscripten)
set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "${EMSCRIPTEN_ROOT}/cmake/Modules/Platform/Emscripten.cmake")

# Enable pthreads / shared-memory for all vcpkg ports.
set(VCPKG_C_FLAGS   "-pthread")
set(VCPKG_CXX_FLAGS "-pthread")
set(VCPKG_LINKER_FLAGS "-pthread")
set(VCPKG_CMAKE_CONFIGURE_OPTIONS
    "-C${CMAKE_CURRENT_LIST_DIR}/../emscripten_threads_cache.cmake"
)